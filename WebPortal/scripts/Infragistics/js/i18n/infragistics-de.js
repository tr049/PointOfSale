...
(function ($) {
    ...
    if (!$.ig.Grid) {
	    ...
	    $.extend($.ig.GridGroupBy, {
		    locale: {
			    ...
			    summaryIconTitle: "Auswahl für {0}: {1}"
		    }
	    });
    ...
    $.extend($.ig.GridSelection, {
	    ...
	    $.extend($.ig.GridRowSelectors, {
		    ...
		    locale: {
			    ...
			    columnVirtualizationEnabled: "igGridRowSelectors wird bei aktivierter Spaltenvirtualisierung nicht unterstützt. Verwenden Sie rowVirtualization oder stellen Sie den virtualizationMode auf 'continuous'.",
	    ...
	    $.extend($.ig.GridUpdating, {
		    locale: {
			    ...
			    virtualizationNotSupportedWithoutAutoCommit: "Die Aktivierung von Aktualisierung und Virtualisierung wird nicht unterstützt, wenn autoCommit auf Falsch festgelegt ist. Bitte aktivieren Sie die Option autoCommit des Rasters."
		    }
        });
        ...
        $.extend($.ig.ColumnMoving, {
            locale: {
                ...
                columnVirtualizationEnabled: "Das Verschieben von Spalten erfordert eine andere Virtualisierungskonfiguration. Verwenden Sie rowVirtualization oder stellen Sie den virtualizationMode auf 'continuous'."
            }
        });
    ...
    $.extend($.ig.igGridMultiColumnHeaders, {
    	locale: {
    	    ...
    	    atLeastOneColumnShouldBeShownWhenCollapseOrExpand: 'Es sollte mindestens eine Spalte angezeigt werden, wenn Sie mehrzeilige Kopfzeilen erweitern oder reduzieren.',
    	    collapsedColumnIconTooltip: "Erweitern",
    	    expandedColumnIconTooltip: "Reduzieren"
    	}
    });
...
/*!@license
* Infragistics.Web.ClientUI utilities localization resources 17.1.20171.1012
*
* Copyright (c) 2011-2017 Infragistics Inc.
*
* http://www.infragistics.com/
