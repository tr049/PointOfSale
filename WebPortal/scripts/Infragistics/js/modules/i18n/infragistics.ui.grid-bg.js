...
if (!$.ig.Grid) {
    ...
    $.extend($.ig.GridGroupBy, {
        locale: {
            ...
            summaryIconTitle: "Обобщение за {0}: {1}"
        }
    });
    ...
    $.extend($.ig.GridHiding, {
        ...
        $.extend($.ig.GridResizing, {
            locale: {
                ...
                resizingAndFixedVirtualizationNotSupported: 'Оразмеряването на колоните изисква различни настройки на виртуализация. Използвайте rowVirtualization или настройте virtualizationMode на "continuous".'
            }
        });
    ...
    $.extend($.ig.GridUpdating, {
        locale: {
            ...
            virtualizationNotSupportedWithoutAutoCommit: " Не е поддържано активирането на Ъпдейтване и виртуализация докато autoCommit е настроено на false. Моля настройте опцията rautoCommit на мрежата на true."
        }
    });
    ...
    $.extend($.ig.ColumnMoving, {
        locale: {
            ...
            columnVirtualizationEnabled: "Преместването на колони изисква различни настройки на виртуализация. Използвайте rowVirtualization или настройте virtualizationMode на 'continuous'."
        }
    });
