...
if (!$.ig.Grid) {
	...
	$.extend($.ig.GridGroupBy, {
		locale: {
			...
			summaryIconTitle: "Résumé pour {0} : {1}"
		}
	});
	...
	$.extend($.ig.GridRowSelectors, {
		...
		locale: {
			...
			columnVirtualizationEnabled: "igGridRowSelectors n'est pas pris en charge lorsque la virtualisation de colonne est activée. Utilisez RowVirtualization ou réglez virtualizationMode sur 'continuous'.",
	...
	$.extend($.ig.GridUpdating, {
		locale: {
            ...
            virtualizationNotSupportedWithoutAutoCommit: "L’activation de mise à jour et de virtualisation lorsque autoCommit est défini sur faux n’est pas prise en charge. Veuillez définir l’option autoCommit de la grille sur vrai."
		}
    });
    ...
    $.extend($.ig.ColumnMoving, {
        locale: {
            ...
            columnVirtualizationEnabled: "Le déplacement de colonne requiert un paramètre de virtualisation différent. Utilisez RowVirtualization ou réglez virtualizationMode sur 'continuous'."
        }
    });
    ...
    $.extend($.ig.igGridMultiColumnHeaders, {
    	locale: {
    	    ...
    	    atLeastOneColumnShouldBeShownWhenCollapseOrExpand: 'Au moins un colonne doit être affichée lorsque vous agrandissez ou réduisez l’en-tête de colonnes multiples.',
    	    collapsedColumnIconTooltip: "Développer",
    	    expandedColumnIconTooltip: "Réduire"
    	}
    });
