    ...
    $.extend($.ig.GridSelection, {
	    ...
	    $.extend($.ig.GridRowSelectors, {
		    ...
		    locale: {
		        ...
		        columnVirtualizationEnabled: "RowSelectors に異なる仮想化設定を使用してください。rowVirtualization を使用、または virtualizationMode を continuous に設定してください。",
	    ...
	    $.extend($.ig.GridUpdating, {
			...
			virtualizationNotSupportedWithoutAutoCommit: "autoCommit が false に設定される場合、更新および仮想化の有効化はサポートされません。グリッドの autoCommit オプションを true に設定してください。"
		    }
	    });
        ...
        $.extend($.ig.ColumnMoving, {
            locale: {
                ...
                columnVirtualizationEnabled: "列移動に異なる仮想化設定が必要です。rowVirtualization を使用、または virtualizationMode を 'continuous' に設定してください。"
            }
        });
