...
(function($) {
	...
	$.extend($.ig.undo.locale, {
		...
		AddItemDescription: "{1} hinzufügen",
		AddItemDescriptionDetailed: "{1} hinzufügen",
		AddRangeDescription: "{1} {2} hinzufügen",
		AddRangeDescriptionDetailed: "{1} {2} hinzufügen",
		...
		MoveItemDescription: "{1} verschieben",
		MoveItemDescriptionDetailed: "{1} von '{2}' nach '{3}' verschieben",
		PropertyChangeDescription: "{0} auf {1} ändern",
		PropertyChangeDescriptionDetailed: "{0} auf {1} in '{2}' ändern",
		ReinitializeCollectionDescription: "Massenänderung",
		ReinitializeCollectionDescriptionDetailed: "Massenänderung",
		RemoveItemDescription: "{1} entfernen",
		RemoveItemDescriptionDetailed: "{1} entfernen",
		RemoveRangeDescription: "{1} {2} entfernen",
		RemoveRangeDescriptionDetailed: "{1} {2} entfernen",
		ReplaceItemDescription: "{1} ersetzen",
		ReplaceItemDescriptionDetailed: "'{1}' durch '{2}' ersetzen"
	});
