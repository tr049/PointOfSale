...
(function($) {
	...
	$.extend($.ig.undo.locale, {
		...
		AddItemDescription: "Ajouter {1}",
		AddItemDescriptionDetailed: "Ajouter {1}",
		AddRangeDescription: "Ajouter {1} {2}(s)",
		AddRangeDescriptionDetailed: "Ajouter {1} {2}(s)",
		...
		MoveItemDescription: "Déplacer {1}",
		MoveItemDescriptionDetailed: "Déplacer {1} de '{2}' à '{3}'",
		PropertyChangeDescription: "Modifier {0} sur {1}",
		PropertyChangeDescriptionDetailed: "Modifier {0} sur {1} à '{2}'",
		ReinitializeCollectionDescription: "Modification en bloc {2}",
		ReinitializeCollectionDescriptionDetailed: "Modification en bloc {2}",
		RemoveItemDescription: "Supprimer {1}",
		RemoveItemDescriptionDetailed: "Supprimer {1}",
		RemoveRangeDescription: "Supprimer {1} {2}(s)",
		RemoveRangeDescriptionDetailed: "Supprimer {1} {2}(s)",
		ReplaceItemDescription: "Remplacer {1}",
		ReplaceItemDescriptionDetailed: "Remplacer '{1}' par '{2}'"
	});
